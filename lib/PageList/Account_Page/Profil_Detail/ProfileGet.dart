...
class _ProfileGetState extends State<ProfileGet> {
  ...
  void initState() {
    super.initState();
    name.text = authController.myUser.value.name ?? '';
    username.text = authController.myUser.value.username ?? '';
    address.text = authController.myUser.value.address ?? '';
    handphone.text = authController.myUser.value.handphone ?? '';
  }
                  ...
                  child: Column(children: [
                    ...
                    InputTextPREG(
                      ...
                      if (!regex.hasMatch(input)) {
                        return 'Masukkan NOMOR/ANGKA bukan HURUF!';
                      }
