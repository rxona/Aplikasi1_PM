...
class Cap_Detail4 extends StatefulWidget {
  const Cap_Detail4({super.key});

  @override
  State<Cap_Detail4> createState() => _Cap_Detail4State();
}

class _Cap_Detail4State extends State<Cap_Detail4> {
  final List<String> _image = ["assets/Category/Cap/4.1.jpeg"];
  int _currentSlide = 0;
