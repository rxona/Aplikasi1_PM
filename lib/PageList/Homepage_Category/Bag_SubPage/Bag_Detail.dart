...
class Bag_Detail extends StatefulWidget {
  const Bag_Detail({super.key});

  @override
  State<Bag_Detail> createState() => _Bag_DetailState();
}

class _Bag_DetailState extends State<Bag_Detail> {
