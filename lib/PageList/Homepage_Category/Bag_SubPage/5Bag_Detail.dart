...
class Bag_Detail5 extends StatefulWidget {
  const Bag_Detail5({super.key});

  @override
  State<Bag_Detail5> createState() => _Bag_Detail5State();
}

class _Bag_Detail5State extends State<Bag_Detail5> {
