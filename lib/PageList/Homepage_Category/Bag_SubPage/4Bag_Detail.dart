...
class Bag_Detail4 extends StatefulWidget {
  const Bag_Detail4({super.key});

  @override
  State<Bag_Detail4> createState() => _Bag_Detail4State();
}

class _Bag_Detail4State extends State<Bag_Detail4> {
