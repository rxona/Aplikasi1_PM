...
class Bag_Detail3 extends StatefulWidget {
  const Bag_Detail3({super.key});

  @override
  State<Bag_Detail3> createState() => _Bag_Detail3State();
}

class _Bag_Detail3State extends State<Bag_Detail3> {
