...
class Misc_Detail2 extends StatefulWidget {
  const Misc_Detail2({super.key});

  @override
  State<Misc_Detail2> createState() => _Misc_Detail2State();
}

class _Misc_Detail2State extends State<Misc_Detail2> {
