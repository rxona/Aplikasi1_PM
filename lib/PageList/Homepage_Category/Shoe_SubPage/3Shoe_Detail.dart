...
class Shoe_Detail3 extends StatefulWidget {
  const Shoe_Detail3({super.key});

  @override
  State<Shoe_Detail3> createState() => _Shoe_Detail3State();
}

class _Shoe_Detail3State extends State<Shoe_Detail3> {
                ...
                child: Column(
                  ...
                  children: [
                    Row(
                      children: [
                        Text(
                          "Sepatu Wanita Flat Karet Jelly\nHYS 857",
                          style: TextStyle(
                            fontFamily: 'Lato',
                            fontSize: 20,
