...
class Pants_Detail4 extends StatefulWidget {
  const Pants_Detail4({super.key});

  @override
  State<Pants_Detail4> createState() => _Pants_Detail4State();
}

class _Pants_Detail4State extends State<Pants_Detail4> {
