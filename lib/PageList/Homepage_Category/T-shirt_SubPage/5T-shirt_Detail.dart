...
class Tshirt_Detail5 extends StatefulWidget {
  const Tshirt_Detail5({super.key});

  @override
  State<Tshirt_Detail5> createState() => _Tshirt_Detail5State();
}

class _Tshirt_Detail5State extends State<Tshirt_Detail5> {
